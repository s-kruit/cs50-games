            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        -- record stat increases as variables
                        local HPIncrease, local attackIncrease, local defenseIncrease, local speedIncrease = self.playerPokemon:levelUp()

                        -- insert menu with stat increases
                        gStateStack:push(
                            StatsIncreaseMenuState(self.playerPokemon.name, HPIncrease, attackIncrease, defenseIncrease, speedIncrease)
                        )
